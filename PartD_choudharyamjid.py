...
result1_a = conn.query(q1_a, db=DATABASE)
result1_b = conn.query(q1_b, db=DATABASE)
...
result2 = conn.query(q2, db=DATABASE)
...
result3_a = conn.query(q3_a, db=DATABASE)
result3_b = conn.query(q3_b, db=DATABASE)
...
result4_a = conn.query(q4_a, db=DATABASE)
result4_b = conn.query(q4_b, db=DATABASE)
